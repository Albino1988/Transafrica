...
class NNFy_Template_Library{
    ...
    function __construct(){
        ...
        if ( is_admin() ) {
            ...
            add_action( 'wp_ajax_nopriv_nnfytmp_ajax_request', [ $this, 'templates_ajax_request' ] );
        }
    ...
    public function scripts( $hook ) {
        ...
        if( '99fy-options_page_nnfy_templates' == $hook ){
            ...
            // CSS
            wp_enqueue_style( 'nnfytmp-stapel', NNFY_ADMIN_ASSETS . 'lib/css/stapel.css', false, NNFY_VERSION );

            wp_enqueue_script(
                'nnfytmp-modernizr',
                NNFY_ADMIN_ASSETS . 'lib/js/modernizr.custom.63321.js',
                [
                    'jquery',
                ],
                false
            ...
            wp_enqueue_script(
                'nnfytmp-stapel',
                NNFY_ADMIN_ASSETS . 'lib/js/jquery.stapel.js',
                [
                    'jquery',
                ],
                true
            ...
            wp_enqueue_script(
                'nnfytmp-admin',
                NNFY_ADMIN_ASSETS . 'js/admin-ajax.js',
                [
                    'jquery',
                ],
                true
        ...
        wp_localize_script(
            ...
            [
                ...
                'packagedesc'      => __( 'Templates in this package', '99fy' ),
                'user'             => [
