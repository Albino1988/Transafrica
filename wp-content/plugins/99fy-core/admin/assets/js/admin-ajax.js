jQuery(document).ready(function($) {
    ...
    // PopUp button
    jQuery('body').on('click', 'a.nnfytemplateimp', function(e) {
        e.preventDefault();
        ...
        var htbtnMarkuplibrary = `<a href="#" class="nnfyimpbtn" data-templateid="${template_opt.templpateid}">${template_opt.htbtnlibrary}</a>`;
        var htbtnMarkuppage = `<a href="#" class="nnfyimpbtn htdisabled" data-templateid="${template_opt.templpateid}">${template_opt.htbtnpage}</a>`;

        // Enter page title then enable button
        $('#htpagetitle').on('input', function () {
            if( !$('#htpagetitle').val() == '' ){
                $(".htimport-button-dynamic-page .nnfyimpbtn").removeClass('htdisabled');
            } else {
                $(".htimport-button-dynamic-page .nnfyimpbtn").addClass('htdisabled');
            }
        });
    ...
    // Import data request
    jQuery('body').on('click', 'a.nnfyimpbtn', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                $(".htmessage").show();
                var tmediturl = NNFYTM.adminURL+"/post.php?post="+ data.id +"&action=elementor";
