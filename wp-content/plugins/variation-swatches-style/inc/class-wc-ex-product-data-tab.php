		...
		<div class="fields_header ata_wcvs_heading">
			<table class="wcsap widefat">
				...
				<th class="attribute_swatch_label">
					<?php _e( 'Product Attribute Name', 'variation-swatches-style' ); ?>
				</th>
				<th class="attribute_swatch_type">
					<span><?php _e( 'Attribute Control Type', 'variation-swatches-style' ); ?></span>
				</th>
				</thead>
			</table>
		</div>
									...
									<tr>
										...
										<td class="attribute_swatch_type">
                                            <select class="_swatch_type_options_type" id="_swatch_type_options_<?php echo $key_attr; ?>_type" name="_swatch_type_options[<?php echo $key; ?>][type]">
                                                <option <?php selected( $current_type, 'default' ); ?> value="default"><?php _e( 'None', 'variation-swatches-style' ); ?></option>
                                                <?php if ( $current_is_taxonomy ) : ?>
                                                    <option <?php selected( $current_type, 'term_options' ); ?> value="term_options"><?php _e( 'Taxonomy Lebel, Colors and Images', 'variation-swatches-style' ); ?></option>
                                                <?php endif; ?>
                                                <option <?php selected( $current_type, 'product_color' ); ?> value="product_color"><?php _e( 'Custom Colors', 'variation-swatches-style' ); ?></option>
                                                  <option <?php selected( $current_type, 'product_image' ); ?> value="product_image"><?php _e( 'Custom Images', 'variation-swatches-style' ); ?></option>
                                                    <option <?php selected( $current_type, 'product_label' ); ?> value="product_label"><?php _e( 'Custom Lebel', 'variation-swatches-style' ); ?></option>
								 ...
								 ?>
                                    ...
                                    <div class="sub_field field">
                                        ...
                                        <div class="wcsap_field_meta ata_wcvs_meta">
                                                ...
                                                <a href="javascript:void(0)" class="button ata_woo_meta_uploader" data-uploader-title="Add image(s) to  <?php echo esc_attr( $attribute_term['label'] ); ?>" data-uploader-button-text="Add image(s)  <?php echo esc_attr( $attribute_term['label'] ); ?> "> <?php _e( 'Upload/Add image', 'variation-swatches-style' ); ?></a>
                                                <a ref="javascript:void(0)" class="remove_ata_woo_meta_img button "><?php _e( 'Remove image', 'variation-swatches-style' ); ?></a>
