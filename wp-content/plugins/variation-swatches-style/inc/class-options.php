...
class ATA_WC_Variation_Swatches_Options {
    ...
    function get_settings_sections() {
        ...
        $sections = array(
			 array(
                'id'    => 'atawc_label',
                'title' => __( 'Label Variation Settings', 'variation-swatches-style' )
            ),
            array(
                'id'    => 'atawc_color',
                'title' => __( 'Color Variation Settings', 'variation-swatches-style' )
            ),
            array(
                'id'    => 'atawc_images',
                'title' => __( 'Images Variation Settings', 'variation-swatches-style' )
            )
        ...
        $settings_fields = array(
            'atawc_label' => array(
				array(
                    ...
                    'label'   => __( 'label Variation Style', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'square',
                    'options' => array(
                ...
                array(
                    ...
                    'label'             => __( 'label Variation Button Width', 'variation-swatches-style' ),
                    'default' 			=> 40,
                    'type'              => 'number',
				...
				array(
                    ...
                    'label'             => __( 'label Variation Button Height', 'variation-swatches-style' ),
                    'default' 			=> 40,
                    'type'              => 'number',
                    'sanitize_callback' => 'number'
                ),
				array(
                    ...
                    'label'             => __( 'label Variation Font Size', 'variation-swatches-style' ),
                    'default' 			=> 13,
                    'type'              => 'number',
                    'sanitize_callback' => 'number',
               ...
               array(
                    ...
                    'label'   => __( 'label Variation Button Color', 'variation-swatches-style' ),
                    'type'    => 'color',
                    'default' => '#c8c8c8'
                ),
				array(
                    'name'    => 'lebel_variation_color_hover',
                    'label'   => __( 'label Variation Button Hover Color', 'variation-swatches-style' ),
                    'type'    => 'color',
                    'default' => '#000'
                ),
				array(
                    'name'    => 'lebel_variation_background',
                    'label'   => __( 'label Variation Button Background', 'variation-swatches-style' ),
                    'type'    => 'color',
                    'default' => '#fff'
                ),
				array(
                    'name'    => 'lebel_variation_background_hover',
                    'label'   => __( 'label Variation Button Background Hover', 'variation-swatches-style' ),
                    'type'    => 'color',
                    'default' => '#c8c8c8'
                ),
				...
				array(
                    ...
                    'label'   => __( 'label Variation border Color', 'variation-swatches-style' ),
                    'type'    => 'color',
                    'default' => '#000'
                ),
				array(
                    'name'    => 'lebel_variation_border_hover',
                    'label'   => __( 'label Variation border Color Hover', 'variation-swatches-style' ),
                    'type'    => 'color',
                    'default' => '#c8c8c8'
                ),
				array(
                    'name'    => 'lebel_variation_ingredient',
                    'label'   => __( 'label active ingredient', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'opacity',
                    'options' => array(
            ...
            'atawc_color' => array(
               array(
                    ...
                    'label'   => __( 'Color Variation Style', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'round',
                    'options' => array(
                        'square' => __( 'Square', 'variation-swatches-style' ),
                ...
                array(
                    ...
                    'label'             => __( 'Color Variation Button Width', 'variation-swatches-style' ),
                    'default' 			=> 40,
                    'type'              => 'number',
                    'sanitize_callback' => 'number'
                ),
				array(
                    ...
                    'label'             => __( 'Color Variation Button Height', 'variation-swatches-style' ),
                    'default' 			=> 40,
                    'type'              => 'number',
                    'sanitize_callback' => 'number'
                ),
				...
				array(
                    ...
                    'label'   => __( 'Color Variation tooltip', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'yes',
                    'options' => array(
				...
				array(
                    ...
                    'label'   => __( 'Color active ingredient', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'tick_sign',
                    'options' => array(
                        'tick_sign' => __( 'Tick sign', 'variation-swatches-style' ),
            ...
            'atawc_images' => array(
               array(
                ...
                array(
                    ...
                    'label'             => __( 'Image Variation Button Width', 'variation-swatches-style' ),
                    'default' 			=> 44,
                    'type'              => 'number',
                    'sanitize_callback' => 'number'
                ),
				array(
                    ...
                    'label'             => __( 'Image Variation Button Height', 'variation-swatches-style' ),
                    'default' 			=> 44,
                    'type'              => 'number',
                    'sanitize_callback' => 'number'
                ),
				...
				array(
                    ...
                    'label'   => __( 'Image Variation tooltip', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'yes',
                    'options' => array(
                        'yes' => __( 'Yes', 'variation-swatches-style' ),
				...
				array(
                    ...
                    'label'   => __( 'Image active ingredient', 'variation-swatches-style' ),
                    'type'    => 'select',
                    'default' => 'tick_sign',
                    'options' => array(
                        'tick_sign' => __( 'Tick sign', 'variation-swatches-style' ),
