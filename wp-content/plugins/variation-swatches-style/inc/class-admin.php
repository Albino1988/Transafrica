...
<a href="javascript:void(0)" class="button ata_woo_meta_uploader" data-uploader-title="<?php _e( 'Add image to Attribute ', 'variation-swatches-style' ); ?>" data-uploader-button-text="<?php _e( 'Add image to Attribute ', 'variation-swatches-style' ); ?>  "> <?php _e( 'Upload/Add image', 'variation-swatches-style' ); ?></a>
...
<div style="clear:both"></div>
	...
	public function product_option_terms( $taxonomy, $index ) {
		...
		<select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select terms', 'variation-swatches-style' ); ?>" class="multiselect attribute_values wc-enhanced-select" name="attribute_values[<?php echo $index; ?>][]">
			<?php
		...
		<button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'variation-swatches-style' ); ?></button>
		<button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'variation-swatches-style' ); ?></button>
		<button class="button fr plus atawc_add_new_attribute" data-type="<?php echo $taxonomy->attribute_type ?>"><?php esc_html_e( 'Add new', 'variation-swatches-style' ); ?></button>
