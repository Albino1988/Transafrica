...
final class ATA_WC_Variation_Swatches {
	...
	public function __construct() {
		$this->types = array(
			...
			//'radio' => esc_html__( 'Radio', 'variation-swatches-style' ),
		);
...
function ata_wc_variation_swatches_wc_notice() {
	...
	<div class="error">
		<p><?php esc_html_e( 'Smart Variation Swatches for WooCommerce Swatches is enabled but not effective. It requires WooCommerce in order to work.', 'variation-swatches-style' ); ?></p>
	</div>
