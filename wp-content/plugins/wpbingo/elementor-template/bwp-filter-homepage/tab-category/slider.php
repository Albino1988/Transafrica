...
if( $category ){ 	
	...
	$numberposts = (int)$numberposts;
?>
<div class="bwp-filter-homepage slider <?php echo esc_attr($layout);?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>"  data-showmore="<?php echo esc_attr($columns); ?>">
