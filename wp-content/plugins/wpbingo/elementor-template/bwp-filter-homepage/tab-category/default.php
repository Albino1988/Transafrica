...
if( $category ){	
	...
	$cat_selected = '';	
?>
<div class="bwp-filter-homepage tab-category-default <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>"  data-showmore="<?php echo esc_attr($columns); ?>">
