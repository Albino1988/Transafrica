							...
							<div class="products-content">
								...
								<div class="product-button">
									<div class="button-style">
										<?php
										if(function_exists("phami_woocommerce_template_loop_add_to_cart")){
											phami_woocommerce_template_loop_add_to_cart();
										}
										if(function_exists("phami_add_loop_wishlist_link")){
											phami_add_loop_wishlist_link();
										}
										if(function_exists("phami_quickview")){
											phami_quickview();
										}
										?>
									</div>
