...
class WpbingoShortcodesClass {
	...
	function wpbingo_remove_default_action(){
		if(class_exists( 'YITH_WCWL' )){
			wpbingo_remove_object_filter('wp_head','YITH_WCWL_Frontend','add_button');
		}
		if(class_exists( 'YITH_WOOCOMPARE' )){
			wpbingo_remove_object_filter('woocommerce_after_shop_loop_item','YITH_Woocompare_Frontend','add_compare_link',20);
			wpbingo_remove_object_filter('woocommerce_single_product_summary','YITH_Woocompare_Frontend','add_compare_link',35);		
		}
	}	
