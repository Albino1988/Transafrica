	...
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="about-theme">
			<div class="theme-description">
				...
				?></p>
				<p class="actions">
					<a href="https://fireflythemes.com/demo/versatile-business" class="button button-secondary" target="_blank"><?php esc_html_e( 'Info', 'versatile-business' ); ?></a>

					<a href="https://fireflythemes.com/themes/versatile-business/#theme-instructions" class="button button-primary" target="_blank"><?php esc_html_e( 'Documentation', 'versatile-business' ); ?></a>

					<a href="https://fireflythemes.com/demo/versatile-business" class="button button-secondary" target="_blank"><?php esc_html_e( 'Demo', 'versatile-business' ); ?></a>

					<a href="https://fireflythemes.com/themes/versatile-business-pro" class="button button-secondary green" target="_blank"><?php esc_html_e( 'Versatile Business Pro', 'versatile-business' ); ?></a>
				</p>
			</div>
	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="https://fireflythemes.com/support" class="button button-primary"><?php esc_html_e( 'Support', 'versatile-business' ); ?></a></p>
			</div>
		</div>
	<?php
	}
