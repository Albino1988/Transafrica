				...
				<div class="topbar-inner">
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 topbar-left">
							...
							<div class="time-open hidden-xs hidden-md">
		...
		<div class='header-wrapper '>
			<div class='header-content' data-sticky_header="<?php echo esc_attr($enable_sticky_header); ?>">
				...
				<div class="header-top">
					<div class="container">
						<div class="row">
							<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-search-form hidden-sm hidden-xs">
								<!-- Begin Search -->
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 header-logo">
					...
					<div class="container">
						<div class="header-contents">
							<div class="row">
								...
								<div class="col-xl-6 col-lg-9 col-md-6 col-sm-6 col-6 wpbingo-menu-mobile header-main">
								...
								<div class="right-menu col-xl-3 col-lg-3 col-md-12 col-sm-12 hidden-md hidden-xs hidden-sm ">
									<?php if( isset($phami_settings['phone']) && $phami_settings['phone'] ) : ?>
										<div class="phone hidden-md hidden-sm hidden-xs">
											...
											<div class="text"><span><?php echo esc_html($phami_settings['phone']); ?></span></div>
										</div>
									<?php endif; ?>
								</div>
							</div>
				...
				<?php }else{ ?>
					<div class="header-default">
						<div class="container">
							<div class="row">
								<div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-8 header-test header-logo">
									<?php phami_header_logo(); ?>
								</div>
								<div class="col-xl-10 col-lg-10 col-md-6 col-sm-6 col-4 header-test wpbingo-menu-mobile header-main">
									<div class="content-header">
										<div class="header-menu-bg">
											<?php phami_top_menu(); ?>
										</div>
